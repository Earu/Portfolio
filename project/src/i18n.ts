...
const resources = {
	en: {
		translation: {
			...
			CONSOLE_FUN_INFO: `By the way, you can find the code for this website here: ${getPrivacyVariable("GITHUB_URL")}/Portfolio`,
			...
			SCHEDULE_URL: getPrivacyVariable("MEETING_URL"),
	...
	fr: {
	  translation: {
		...
		CONSOLE_FUN_INFO: `Au fait, vous pouvez trouver le code de ce site web ici : ${getPrivacyVariable("GITHUB_URL")}/Portfolio`,
		...
		HEADER_HERO_TEXT: "Bonjour, moi c'est <0>{{NAME}}</0>, <1>Développeur</1> et <2>Architecte</2>, et je peux aider votre entreprise à <3>atteindre de nouveaux horizons!</3>",
		...
		SCHEDULE_URL: getPrivacyVariable("MEETING_URL_FR"),
